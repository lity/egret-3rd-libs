...
declare namespace Colyseus {
    // type FunctionParameters<T extends (...args: any[]) => any> = T extends (...args: infer P) => any ? P : never; // 为了适配 egret 注释掉 
...
declare namespace Colyseus {
    class Room<T = any> extends StateContainer {
        ...
        // onMessage<T extends (new (...args: any[]) => any)>(type: T, callback: (message: InstanceType<T>) => void): any; // 为了适配 egret 注释掉
